...
public class BodyNode
{
    ...
    public delegate void SetRawQuaternion(float x, float y, float z, float w);
    public SetRawQuaternion setRawQuaternion;

    public BodyNode(Transform gameobjTrans, Quaternion flipQ, bool positionedVertically)
    {
        ...
        if (positionedVertically)
        {
            setRawQuaternion = setRawVertical;
        }
        else
        {
            setRawQuaternion = setRawFlat;
        }
    }
 ...
 */
    ...
    void setRawFlat(float x, float y, float z, float w)
    {
    ...
    /**The module is place in vertical position on the body, i.e the main body*/
    void setRawVertical(float x, float y, float z, float w)
    {
        //the axis is swapped
        rawQuaternion.Set(-z, -x, y, w);
        // do the initial calibration
        if (!isCalibrated)
        {
            //setRawAsInitial();
